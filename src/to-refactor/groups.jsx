...
export default function Groups() {
  ...
  return (
    <SimpleLayout
      ...
      intro={
        'The BoulderJS hosts a number of Meet & Greet events that are open to everyone. We also host special cross-technology events called "CDCx". The participating groups are responsible for their own events and content. A list and calendar of all events from participating groups in Cyprus will be coming soon.'
      }
    >
      <ul
        role="list"
